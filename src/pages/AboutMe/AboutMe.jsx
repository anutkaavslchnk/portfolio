...
<div className={s.imgcont}>
    <img src="/src/img/main.jpeg" alt="my-photo" className={s.photo} />
</div>
<div className={s.int}>
   ...
   <br />Motivated  Web developer</h2>
    ...
    <a  href="/src/img/Anna_Vasylchenko_FronendDev.pdf" download className={s.btn}>Download Resume</a>
</div>
</section>
...
<li className={s.item_ed}>
    ...
    <div className={s.overlay}>
        <img  className={s.uam_photo}src="/src/img/HSGHAF29_400x400.jpg" alt="uam" />
...
<li className={s.item_ed}>
    ...
    <div className={s.overlay}>
    <img  className={s.goit_main}src="/src/img/images.png" alt="goIt" />
